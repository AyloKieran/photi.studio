<x-app-layout title="{{ __('Privacy Policy') }}">
    <x-header title="{{ __('Privacy Policy') }}" subtitle="{{ __('Last updated February 26, 2023') }}" />
    <div class="content__holder">
        <x-section title="{{ __('') }}">
            <p>
                This privacy notice for Photi.Studio (doing business as Photi) (' Photi ', 'we', 'us', or 'our' ),
                describes how
            ...
            <p>
                Visit our website at photi.studio , or any website of ours that links to this privacy notice
                Download and use our mobile application ( Photi.Studio) , or any other application of ours that links to
                this
                privacy notice
            </p>
            <p>
                ...
                questions or concerns, please contact us at howdy+photi@kierannoble.dev.
            </p>
            <p>This privacy notice was generated by Termly.</p>
        </x-section>

        <x-section title="{{ __('Summary of Key Points') }}">
            ...
            <p> What personal information do we process? When you visit, use, or navigate our Services, we may process
                personal
                information depending on how you interact with Photi and the Services, the choices you make, and the
                products
                and features you use. </p>
            <p>Do we process any sensitive personal information? We do not process sensitive personal information.</p>
            <p>Do we receive any information from third parties? We do not receive any information from third parties.
            </p>
            ...
            <p>n what situations and with which parties do we share personal information? We may share information in
                specific
                situations and with specific third parties.</p>
            <p>In what situations and with which parties do we share personal information? We may share information in
                specific
                situations and with specific third parties.</p>
            <p>How do we keep your information safe? We have organisational and technical processes and procedures in
                place to
                ...
                access,
                steal, or modify your information.</p>
            <p> What are your rights? Depending on where you are located geographically, the applicable privacy law may
                mean you
                have certain rights regarding your personal information.</p>
        ...
        <x-section title="{{ __('What information do we collect?') }}">
            ...
            <p> Personal Information Provided by You. The personal information that we collect depends on the context of
                ...
                personal
                information we collect may include the following: names, email addresses, usernames, passwords and
        ...
        <x-section title="{{ __('How do we proces your infromation?') }}">
            <p>In Short: We process your information to provide, improve, and administer our Services, communicate with
                you,
            ...
            <p>To save or protect an individual's vital interest. We may process your information when necessary to save
                or
                protect an individual’s vital interest, such as to prevent harm.</p>
        </x-section>
        <x-section title="{{ __('What legal bases do we rely on to process your information?') }}">
            <p>In Short: We only process your personal information when we believe it is necessary and we have a valid
                legal
                reason (i.e. legal basis) to do so under applicable law, like with your consent, to comply with laws, to
                provide
                you with services to enter into or fulfil our contractual obligations, to protect your rights, or to
                fulfil our
            ...
            <p>The General Data Protection Regulation (GDPR) and UK GDPR require us to explain the valid legal bases we
                ...
                our
                legal obligations, such as to cooperate with a law enforcement body or regulatory agency, exercise or
                defend our
            ...
            <p>We may process your information if you have given us specific permission (i.e. express consent) to use
                ...
                (i.e.
                implied consent). You can withdraw your consent at any time. Click here to learn more.</p>
        ...
        <x-section title="{{ __('When and with whom do we share your personal information?') }}">
        ...
        <x-section title="{{ __('Do we use cookies and other tracking technologies?') }}">
        ...
        <x-section title="{{ __('How long do we keep for information?') }}">
            <p>In Short: We keep your information for as long as necessary to fulfil the purposes outlined in this
                privacy
            ...
            <p>We will only keep your personal information for as long as it is necessary for the purposes set out in
                ...
                accounting, or
                other legal requirements). No purpose in this notice will require us keeping your personal information
                for
            ...
            <p>When we have no ongoing legitimate business need to process your personal information, we will either
                delete or
                anonymise such information, or, if this is not possible (for example, because your personal information
                has been
        ...
        <x-section title="{{ __('How do we keep your information safe?') }}">
            <p>In Short: We aim to protect your personal information through a system of organisational and technical
                security
                measures.</p>
        ...
        <x-section title="{{ __('DO we collect information from minors?') }}">
            ...
            <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Services,
                ...
                please
                contact us at howdy+photiDPO@kierannoble.dev .</p>
        </x-section>
        <x-section title="{{ __('What are your privacy rights?') }}">
            <p>In Short: In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Canada ,
                you have
            ...
            <p>If you are located in the EEA or UK and you believe we are unlawfully processing your personal
                information, you
                also have the right to complain to your local data protection supervisory authority. You can find their
                contact
            ...
            <p>If you would at any time like to review or change the information in your account or terminate your
                ...
                requirements.</p>
            <p>Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer,
                you can
                ...
                interest-based
                advertising by advertisers on our Services visit http://www.aboutads.info/choices/.</p>
            <p>If you have questions or comments about your privacy rights, you may email us at
                howdy+photiprivacy@kierannoble.dev .</p>
        </x-section>
        <x-section title="{{ __('Controls for do-not-track features') }}">
            <p>Most web browsers and some mobile operating systems and mobile applications include a Do-Not-Track (
                ...
                signals or any
                other mechanism that automatically communicates your choice not to be tracked online. If a standard for
                online
        ...
        <x-section title="{{ __('Do California Residents have specific privacy rights?') }}">
            <p>In Short: Yes, if you are a resident of California, you are granted specific rights regarding access to
                your
                personal information.
                ...
                calendar
                year. If you are a California resident and would like to make such a request, please submit your request
                in
                writing to us using the contact information provided below.

                If you are under 18 years of age, reside in California, and have a registered account with Services, you
                have
                the right to request removal of unwanted data that you publicly post on the Services. To request removal
                of such
                ...
                Browsing history, search history, online behaviour , interest data, and interactions with our and other
                ...
                You may contact us by email at howdy+photiccpa@kierannoble.dev , or by referring to the contact details
                at the
                ...
                between us
                and each service provider. Each service provider is a for-profit entity that processes the information
                on our
                ...
                Photi.Studio has not disclosed, sold, or shared any personal information to third parties for a business
                or
                commercial purpose in the preceding twelve (12) months. Photi.Studio will not sell or share personal
                information
                ...
                information, we
                will respect your request and delete your personal information, subject to certain exceptions provided
                by law,
                ...
                communication method (e.g. phone or email) that you have previously provided to us. We may also use
                other
                verification methods as the circumstances dictate.

                We will only use personal information provided in your request to verify your identity or authority to
                make the
                request. To the extent possible, we will avoid requesting additional information from you for the
                purposes of
                verification. However, if we cannot verify your identity from the information already maintained by us,
                we may
                ...
                request
                from an authorised agent that does not submit proof that they have been validly authorised to act on
                your behalf
                ...
                To exercise these rights, you can contact us by email at howdy+photiccpa@kierannoble.dev , or by
                referring to
        ...
        <x-section title="{{ __('Do Virginia Residents have specific privacy rights?') }}">
            <p>In Short: Yes, if you are a resident of Virginia, you may be granted specific rights regarding access to
                and use
                ...
                Photi.Studio and our Services. To find out more, please visit the following links:
                ...
                effects (
                'profiling' )
                Photi.Studio has not sold any personal data to third parties for business or commercial purposes.
                Photi.Studio
                ...
                You may contact us by email at howdy+photiprivacy@kierannoble.dev , by visiting our data subject request
                form ,
                or by referring to the contact details at the bottom of this document.

                If you are using an authorised agent to exercise your rights, we may deny a request if the authorised
                agent does
                not submit proof that they have been validly authorised to act on your behalf.

                Verification process

                We may request that you provide additional information reasonably necessary to verify you and your
                consumer's
                request. If you submit the request through an authorised agent, we may need to collect additional
                information to
                ...
                necessary. We will inform you of any such extension within the initial 45-day response period, together
                with the
                ...
                behind it.
                If you wish to appeal our decision, please email us at howdy+photiprivacy@kierannoble.dev . Within sixty
                (60)
                days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response
                to the
                appeal, including a written explanation of the reasons for the decisions. If your appeal if denied, you
                may
                contact the Attorney General to submit a complaint.</p>
        </x-section>
        <x-section title="{{ __('Do we makes updates to this notice?') }}">
        ...
        <x-section title="{{ __('How can you contact us about this notice?') }}">
            <p>If you have questions or comments about this notice, you may email us at howdy+photiDPO@kierannoble.dev
            </p>
        </x-section>
        <x-section title="{{ __('How can you review, update or delete the data we collect from you?') }}">
            <p>Based on the applicable laws of your country, you may have the right to request access to the personal
                ...
                delete
                your personal information, please email howdy+photi@kierannoble.dev .</p>
        </x-section>
    </div>
</x-app-layout>
